...
func bindDatahub(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := DatahubMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
func (_Datahub *DatahubCaller) GetActiveBidsByHash(opts *bind.CallOpts, addr common.Address, requestHash [32]byte) (DataHubActiveBid, error) {
	var out []interface{}
	err := _Datahub.contract.Call(opts, &out, "getActiveBidsByHash", addr, requestHash)
...
func (_Datahub *DatahubSession) GetActiveBidsByHash(addr common.Address, requestHash [32]byte) (DataHubActiveBid, error) {
	return _Datahub.Contract.GetActiveBidsByHash(&_Datahub.CallOpts, addr, requestHash)
}
...
func (_Datahub *DatahubCaller) GetAllSubItemsForNameHash(opts *bind.CallOpts, nameHash [32]byte) ([]DataHubSubItem, error) {
	var out []interface{}
	err := _Datahub.contract.Call(opts, &out, "getAllSubItemsForNameHash", nameHash)
...
func (_Datahub *DatahubSession) GetAllSubItemsForNameHash(nameHash [32]byte) ([]DataHubSubItem, error) {
	return _Datahub.Contract.GetAllSubItemsForNameHash(&_Datahub.CallOpts, nameHash)
}
...
func (_Datahub *DatahubCaller) GetNameHashSubItems(opts *bind.CallOpts, nameHash [32]byte) ([][32]byte, error) {
	var out []interface{}
	err := _Datahub.contract.Call(opts, &out, "getNameHashSubItems", nameHash)
...
func (_Datahub *DatahubSession) GetNameHashSubItems(nameHash [32]byte) ([][32]byte, error) {
	return _Datahub.Contract.GetNameHashSubItems(&_Datahub.CallOpts, nameHash)
}
...
//
// Solidity: function getSubBy(bytes32 subHash) view returns((bytes32,bytes32,address,bytes32,uint256,bool,uint256,bytes32,uint256,uint256,uint256,uint256))
...
//
// Solidity: function getSubByIndex(uint256 index) view returns((bytes32,bytes32,address,bytes32,uint256,bool,uint256,bytes32,uint256,uint256,uint256,uint256))
...
//
// Solidity: function getSubs() view returns((bytes32,bytes32,address,bytes32,uint256,bool,uint256,bytes32,uint256,uint256,uint256,uint256)[])
...
//
// Solidity: function subscriptions(uint256 ) view returns(bytes32 subHash, bytes32 fdpSellerNameHash, address seller, bytes32 swarmLocation, uint256 price, bool active, uint256 earned, bytes32 category, uint256 bids, uint256 sells, uint256 reports, uint256 daysValid)
func (_Datahub *DatahubCaller) Subscriptions(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.Category = *abi.ConvertType(out[7], new([32]byte)).(*[32]byte)
	outstruct.Bids = *abi.ConvertType(out[8], new(*big.Int)).(**big.Int)
	outstruct.Sells = *abi.ConvertType(out[9], new(*big.Int)).(**big.Int)
	outstruct.Reports = *abi.ConvertType(out[10], new(*big.Int)).(**big.Int)
	outstruct.DaysValid = *abi.ConvertType(out[11], new(*big.Int)).(**big.Int)
...
func (_Datahub *DatahubTransactor) ListSub(opts *bind.TransactOpts, fdpSellerNameHash [32]byte, dataSwarmLocation [32]byte, price *big.Int, category [32]byte, podAddress common.Address, daysValid *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function listSub(bytes32 fdpSellerNameHash, bytes32 dataSwarmLocation, uint256 price, bytes32 category, address podAddress, uint256 daysValid) payable returns()
func (_Datahub *DatahubSession) ListSub(fdpSellerNameHash [32]byte, dataSwarmLocation [32]byte, price *big.Int, category [32]byte, podAddress common.Address, daysValid *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function listSub(bytes32 fdpSellerNameHash, bytes32 dataSwarmLocation, uint256 price, bytes32 category, address podAddress, uint256 daysValid) payable returns()
func (_Datahub *DatahubTransactorSession) ListSub(fdpSellerNameHash [32]byte, dataSwarmLocation [32]byte, price *big.Int, category [32]byte, podAddress common.Address, daysValid *big.Int) (*types.Transaction, error) {
	return _Datahub.Contract.ListSub(&_Datahub.TransactOpts, fdpSellerNameHash, dataSwarmLocation, price, category, podAddress, daysValid)
}
...
func (_Datahub *DatahubTransactor) RequestAgain(opts *bind.TransactOpts, requestHash [32]byte) (*types.Transaction, error) {
	return _Datahub.contract.Transact(opts, "requestAgain", requestHash)
}
...
func (_Datahub *DatahubSession) RequestAgain(requestHash [32]byte) (*types.Transaction, error) {
	return _Datahub.Contract.RequestAgain(&_Datahub.TransactOpts, requestHash)
}
