...
// DocPutRequest represents request structure for putting entry in document store
...
// DocDeleteRequest represents request structure for deleting document store
