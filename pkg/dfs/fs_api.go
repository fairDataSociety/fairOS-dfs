...
func (a *API) Mkdir(podName, dirToCreateWithPath, sessionId string, mode uint32, isGroup bool) error {
	...
	podInfo, podPassword, err := &pod.Info{}, "", error(nil)
	if isGroup {
		podInfo, podPassword, err = ui.GetGroup().GetGroupInfoFromMap(podName)
	} else {
...
func (a *API) RenameDir(podName, dirToRenameWithPath, newName, sessionId string, isGroup bool) error {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return ErrUserNotLoggedIn
	...
	podInfo, err := &pod.Info{}, error(nil)
	if isGroup {
		podInfo, _, err = ui.GetGroup().GetGroupInfoFromMap(podName)
	} else {
...
func (a *API) IsDirPresent(podName, directoryNameWithPath, sessionId string, isGroup bool) (bool, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
	...
	dirPresent := directory.IsDirectoryPresent(directoryNameWithPath, podInfo.GetPodPassword())
...
func (a *API) RmDir(podName, directoryNameWithPath, sessionId string, isGroup bool) error {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return ErrUserNotLoggedIn
...
func (a *API) ListDir(podName, currentDir, sessionId string, isGroup bool) ([]dir.Entry, []f.Entry, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
...
func (a *API) DirectoryStat(podName, directoryPath, sessionId string, isGroup bool) (*dir.Stats, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
...
func (a *API) DirectoryInode(podName, directoryName, sessionId string, isGroup bool) (*dir.Inode, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return nil, ErrUserNotLoggedIn
...
func (a *API) ChmodDir(podName, directoryNameWithPath, sessionId string, mode uint32, isGroup bool) error {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return ErrUserNotLoggedIn
...
// directory.
func (a *API) DeleteFile(podName, podFileWithPath, sessionId string, isGroup bool) error {
	...
	if err != nil {
		if errors.Is(err, f.ErrDeletedFeed) {
...
func (a *API) FileStat(podName, podFileWithPath, sessionId string, isGroup bool) (*f.Stats, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return nil, ErrUserNotLoggedIn
...
func (a *API) UploadFile(podName, podFileName, sessionId string, fileSize int64, fd io.Reader, podPath, compression string, blockSize, mode uint32, overwrite, isGroup bool) error {
	...
	if podInfo == nil {
		return errors.New("pod/group does not exist")
	}
	file := podInfo.GetFile()
	directory := podInfo.GetDirectory()
...
func (a *API) RenameFile(podName, fileNameWithPath, newFileNameWithPath, sessionId string, isGroup bool) error {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return ErrUserNotLoggedIn
...
func (a *API) DownloadFile(podName, podFileWithPath, sessionId string, isGroup bool) (io.ReadCloser, uint64, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
...
func (a *API) WriteAtFile(podName, fileNameWithPath, sessionId string, update io.Reader, offset uint64, truncate, isGroup bool) (int, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
...
// pod is open and calls the download function.
func (a *API) ReadSeekCloser(podName, podFileWithPath, sessionId string, isGroup bool) (io.ReadSeekCloser, uint64, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return nil, 0, ErrUserNotLoggedIn
...
func (a *API) ShareFile(podName, podFileWithPath, destinationUser, sessionId string, isGroup bool) (string, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return "", ErrUserNotLoggedIn
...
func (a *API) ReceiveFile(podName, sessionId, ref, dir string) (string, error) {
	...
	return a.users.ReceiveFileFromUser(ui, ui.GetPod(), podName, ref, dir)
}
...
func (a *API) StatusFile(podName, podFileWithPath, sessionId string, isGroup bool) (int64, int64, int64, error) {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
...
func (a *API) ChmodFile(podName, podFileWithPath, sessionId string, mode uint32, isGroup bool) error {
	// get the logged-in user information
	ui := a.users.GetLoggedInUserInfo(sessionId)
	if ui == nil {
		return ErrUserNotLoggedIn
